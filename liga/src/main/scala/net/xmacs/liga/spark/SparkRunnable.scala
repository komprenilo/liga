...
import net.xmacs.liga.model.{Model, Registry}
import org.apache.spark.sql.catalyst.expressions.Expression

/** Make [[Model]] runnable on Spark.
  *
  ...
  * @note
  *
  * It is the [[Registry]]'s responsibility to implement a
  * Model that runs with Spark SQL.
  * @example
  *
  * To implement a [[Model]] for '''`RegistryFoo`''':
  *
  * {{{
